...
This is been linked with RegisterScreen
...
class LoginScreen extends React.Component {
  ...
  //login user by using loginuser function provided by the AuthService
  handleLogin = () => {
    const {email, password} = this.state;
    AuthService.loginUser(email, password).catch((error) =>
